...
using InboxNet.Inbox.Observability;

namespace InboxNet.Inbox.AspNetCore;
...
public static class InboxEndpointRouteBuilderExtensions
{
    ...
    private static async Task<IResult> HandleAsync(HttpContext context, string providerKey)
    {
        ...
        var logger = sp.GetRequiredService<ILoggerFactory>().CreateLogger("InboxNet.Inbox.Webhook");
